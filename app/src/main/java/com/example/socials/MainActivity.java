...
public class MainActivity extends AppCompatActivity {
    ...
    int CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE = 42;
    File photoFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCamera = findViewById(R.id.btnPicture);
    ...
    private void savePosts(ParseUser user, String description, File image) {
        Post post = new Post();
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e != null) {
                    ...
                    Toast.makeText(MainActivity.this, "Could not post", Toast.LENGTH_SHORT).show();
                }
